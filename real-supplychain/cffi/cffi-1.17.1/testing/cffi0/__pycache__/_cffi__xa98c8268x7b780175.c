...
double test1iarm(double x) { return x * 42.0; }
...
static PyMethodDef _cffi_methods[] = {
  {"test1iarm", _cffi_f_test1iarm, METH_O, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__xa98c8268x7b780175(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xa98c8268x7b780175(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xa98c8268x7b780175", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
