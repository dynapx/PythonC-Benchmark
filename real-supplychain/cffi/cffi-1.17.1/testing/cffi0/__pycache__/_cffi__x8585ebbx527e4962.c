...
/*7<testing.cffi0.test_zdistutils.TestDistUtilsCPython object at 0x713025687150>*/
    #include <math.h>
...
PyMODINIT_FUNC
PyInit__cffi__x8585ebbx527e4962(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x8585ebbx527e4962(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x8585ebbx527e4962", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
